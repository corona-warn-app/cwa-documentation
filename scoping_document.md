...
2. **Exposure**
   ...
   If exposure to infected persons is determined, the user receives a notification and a recommendations on what to do. For instance, the user is asked to contact a medical professional or their responsible health department, or the user is asked to self-isolate or the user is notified that there is no need to self-isolate.
